...
from .sec_constants import SEC_FILING_TYPES, MAJOR_FILING_TYPES, CIK_LENGTH
...
class SECValidator:
    ...
    def validate_filing_type(filing_type: str) -> bool:
        ...
        # Check against known filing types
        return filing_type in SEC_FILING_TYPES or filing_type in MAJOR_FILING_TYPES
