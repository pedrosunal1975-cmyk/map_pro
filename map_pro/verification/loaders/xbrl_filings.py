...
class XBRLFilingsLoader:
    ...
    def find_filing_for_company(
        ...
        """
        # Build expected path
        base_path = self.xbrl_path / market / company / 'filings' / form

        if not base_path.exists():
            self.logger.debug(f"Filing path not found: {base_path}")
            return None
        ...
        # Return most recent filing (sorted descending)
        filings = sorted(
